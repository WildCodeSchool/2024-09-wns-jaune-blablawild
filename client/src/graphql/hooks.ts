...
export type GetReviewsByUserQuery = { __typename?: 'Query', getReviewsByUser: Array<{ __typename?: 'Review', comment: string, date: any, notation: number, id: string, sender: { __typename?: 'User', firstname: string, profile?: { __typename?: 'Profile', image?: string | null } | null }, receiver: { __typename?: 'User', firstname: string } }> };
