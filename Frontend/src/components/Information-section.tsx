...
export const InformationSection = () => (
    <section className="flex flex-col items-center space-y-10 mt-10 md:flex-row md:space-y-0 md:space-x-10 md:mx-auto md:w-10/12 md:items-start lg:space-x-16 lg:mt-20 xl:w-9/12">
